...
/**
 * DAO for table "TREASURY_CART_BEAN".
*/
public class TreasuryCartBeanDao extends AbstractDao<TreasuryCartBean, Long> {

    public static final String TABLENAME = "TREASURY_CART_BEAN";

    /**
     * Properties of entity TreasuryCartBean.<br/>
    ...
    public TreasuryCartBeanDao(DaoConfig config) {
        super(config);
    }
    
    public TreasuryCartBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TREASURY_CART_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TREASURY_CART_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TreasuryCartBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TreasuryCartBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public TreasuryCartBean readEntity(Cursor cursor, int offset) {
        TreasuryCartBean entity = new TreasuryCartBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, TreasuryCartBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TreasuryCartBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TreasuryCartBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TreasuryCartBean entity) {

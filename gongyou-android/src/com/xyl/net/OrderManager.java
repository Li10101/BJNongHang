...
//	}
 public void commitCartData(String data, int type, String caseCode
	...
	public void cmsdata( Integer type ,BaseCallback<NoticeBean> baseCallback) {
		RequestParams params = new RequestParams();
		params.addBodyParameter("type", type+"");
		baseMethod(params, NetContacts.getInstance().CMSDATA, baseCallback, NoticeBean.class);
...
//							}
	...
	public void findallbuildingvos(final BaseCallback<List<FindAllBulidingBean>> baseCallback) {
		RequestParams params = new RequestParams();
		...
		// 进行数据请求
		httpUtils.send(HttpRequest.HttpMethod.POST, NetContacts.getInstance().FINDALLBUILDINGVOS, params,
				new RequestCallBack<String>() {
...
//							}
						...
						List<FindAllBulidingBean> list = gson.fromJson(successInfo,
								new TypeToken<List<FindAllBulidingBean>>() {
								}.getType());
	...
	public void findPermissions(Integer staffId,Integer type,final BaseCallback<List<HomeBean>> baseCallback) {
		RequestParams params = new RequestParams();
		...
		// 进行数据请求
		httpUtils.send(HttpRequest.HttpMethod.POST, NetContacts.getInstance().FINDPERMISSIONS, params,
				new RequestCallBack<String>() {
...
//							}
						...
						List<HomeBean> list = gson.fromJson(successInfo,

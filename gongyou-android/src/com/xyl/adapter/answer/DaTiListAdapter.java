...
public class DaTiListAdapter extends RecyclerView.Adapter<DaTiListAdapter.ViewHolder> {


    private Context mContext;
    private List<DaTiRenDataBean> records;

    public DaTiListAdapter(Context baseContext, List<DaTiRenDataBean> records) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        DaTiRenDataBean recordsBean = records.get(position);
        holder.tvPriority.setText(recordsBean.getDaTiName());
        holder.tvPersion.setText(recordsBean.getDateTime());
//        holder.tvTime.setText();
//        holder.tvPurchaseType.setText();
        holder.tvState.setText(recordsBean.getFenShu()+"");
        holder.tvState.setCompoundDrawables(null,null,null,null);

...
import com.mining.app.zxing.decoding.DecodeHintManager;
...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		boolean isUser = StringUtils.contains(resultString, "userEquipment");
		if (isUser){
			new AssetManager().findAssetEquipmentNo(resultString, new BaseNet.BaseCallback<FindByAssetNoBean.RecordsBean>() {
				@Override
				public void messageSuccess(FindByAssetNoBean.RecordsBean bean) {
					flag=10;
					Intent intent = new Intent(MipcaActivityCapture.this,OrderStateActivity.class);
			...
			new DeviceManager().findEquipmentNo(resultString, new BaseNet.BaseCallback<FindByEquipmentNoBean>() {
				@Override
